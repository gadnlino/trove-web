...
Maintain a fast, local index of all media discovered across mounted providers so
the gallery renders instantly, survives reloads, scans resumably, and reconciles
additions and deletions without re-listing backends on every view.
