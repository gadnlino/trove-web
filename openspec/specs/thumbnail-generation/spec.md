...
Generate image and video thumbnails entirely in the browser, cache them in OPFS
referenced from the catalog, and choose proactive vs on-demand generation based
on each provider's declared capabilities.
